...
contract('EIP20', (accounts) => {
  ...
  it('creation: should succeed in creating over 2^256 - 1 (max) tokens', async () => {
    ...
    const HST2 = await EIP20Abstraction.new(max, 'Simon Bucks', 1, 'SBX', { from: accounts[0] });
  ...
  /*it('transfers: ether transfer should be reversed.', async () => {
    ...
    await truffleAssert.reverts(
      web3.eth.sendTransaction({ from: accounts[0], to: HST.address, value: web3.utils.toWei('10', 'wei') }), "only owner");
